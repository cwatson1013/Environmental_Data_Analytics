...
# place your additional edits here
 ylab(("Concentration (\U003BCg/L)")) +
  ...
  scale_color_manual(values = c("#7fcdbb", "#41b6c4", "#1d91c0", "#225ea8", "#0c2c84"), #defining which colors to use in the graphs
                     name="Nutrient",
                     breaks=c("nh34", "no23", "po4", "tn_ug", "tp_ug"),
                     labels=c("Ammonium", "Nitrate", "Phosphorous", "Total N (\U003BCg/L)", "Total P (\U003BCg/L)")) + 
