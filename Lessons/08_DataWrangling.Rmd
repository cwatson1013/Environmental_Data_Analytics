...
write.csv(NTL.nutrient.data.PeterPaul.gathered, row.names = FALSE, file = "./Data/Processed/PeterPaul.gathered.processed.csv")

write.csv(USGS.flow.data.complete, row.names = FALSE, file = "./Data/Processed/USGS_Stream_Flow_Processed.csv")
write.csv(NTL.nutrient.data.PeterPaul.skinny, row.names = FALSE, file = "./Data/Processed/PeterPaul.Nutrient.data.skinny.csv")
