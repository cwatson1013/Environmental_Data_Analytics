...
PeterPaul.chem.nutrients.gathered <- read.csv("./Data/Processed/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv")

PeterPaul.physics <- read.csv("./Data/Processed/NTL-LTER_Lake_ChemistryPhysics_PeterPaul_Processed.csv")

write.csv(USGS.flow.data.complete, row.names = FALSE, file = "./Data/Processed/USGS_Stream_Flow_Processed.csv")

USGS.flow.data.complete <- read.csv("./Data/Processed/USGS_Stream_Flow_Processed.csv")
