...
> Answer: Reproducible practices are becoming the norm in data analytics because it is important to be able to share your code with others or your future self so that you can understand what was done previously.

### Question
What are your previous experiences with data analytics, R, and Git? Include both formal and informal training.

> Answer: My previous experiences with data analytics and R is the Applied Statistics for the Environmental Sciences. This was a statistics course, so my experience in R was with the weekly lab assignments and learning how to code or use specific statistical functions during lecture. I don't have any experience with Git.

### Question
Are there any components of the course about which you feel confident?

> Answer: I mainly feel confident about using R (to a certain extent). I feel familiar enough with R that I know how it works.

### Question
Are there any components of the course about which you feel apprehensive?

> Answer: I feel a bit apprehensive about the problems that we could run into while using R since this is different from the statistics class I took last semester. I also am not sure I fully understand the connection between R, GitHub, and my files and how to update each respectively, but I'm hoping that will come with time/practice.
